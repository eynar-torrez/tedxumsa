        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    <div class="blog-item">
                        @if($article->path)
                            <img class="img-responsive img-blog" src="{!! url($article->path . $article->file_name) !!}"
                                 width="100%" style="border: 1px solid #bdc3c7;" alt=""/>
                        @else
                            <img class="img-responsive img-blog" src="{!! url('assets/images/blog_default.png') !!}"
                                 width="100%" style="border: 1px solid #bdc3c7; height: 290px;" alt=""/>
                        @endif
                        ...
                        <div class="blog-content">
                            ...
                            <div class="tags">
                                ...
                                @foreach($article->tags as $tag)
                                    <a class="btn btn-xs btn-primary"
                                       href="{!! URL::route('dashboard.tag', array('tag'=>$tag->slug)) !!}">{!! $tag->name !!}</a>
                                @endforeach
                            </div>
                            <p>&nbsp;</p>
                            <br>
                            <div>
                                @foreach($article->coments as $comentario)
                                    <p>
                            ...
                            <p>
                                {!! Form::open(['route' => 'post_comentario']) !!}
